...
<html>
  ...
  <div style="width:300px; float:left">   
         <div id="accordion">
        <h3><a href="./pages/page_0_01.jsp">课程评估--菜单1</a></h3>
        <div>
                                            菜单1的内容<br />
                                            菜单1的内容<br />
                                            菜单1的内容<br />
        ...
        <h3><a href="./pages/page_0_01.jsp">课程评估--菜单2</a></h3>
           <div>菜单2的内容</div>
        
        <h3><a href="./pages/page_0_01.jsp">课程评估--菜单3</a></h3>
           <div>菜单3的内容</div> 
        <h3><a href="./pages/page_0_01.jsp">课程评估--菜单4</a></h3>
           <div>菜单4的内容</div> 
        <h3><a href="./pages/page_0_01.jsp">课程评估--菜单5</a></h3>
           <div>菜单5的内容</div>        
        <h3><a href="./pages/page_0_01.jsp">课程评估--菜单6</a></h3>
           <div>菜单6的内容</div>   
